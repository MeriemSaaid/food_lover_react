    ...
    <div className="container">
      <div className="row">
        <div className="col-md-12 col-lg-8">
          ...
          <span/>
            <h1 className="title-single">Blend of Internatioanl Recipes</h1>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="about-img-box">
            <img src={require("../img/haitian-mozarella.jpg")} alt="" className="HaitianLunch"/>
          </div>
          <div class="sinse-box">
            <h3 className="sinse-title">FoodLove Recipe
              <span></span>
              <br/> December 2018</h3>
