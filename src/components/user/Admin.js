                        ...
                        <div className="tab-content profile-tab" id="myTabContent">
                            <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                      ...
                                      <div className="form-check">
                                        <input className="form-check-input" type="checkbox" checked={chef} name="chef" id="defaultCheck1" onChange={this.changegChef}  />
                                            This user is a chef.
                                      </div>
                                        {/* BUTTONS GO HERE */}
                                        <div>
                                        <br/>
                                          ...
                                          <button type="submit" className="active1 btn-warning btn btn-block">
                                            Delete Account
                                          </button>
                                      </div>
                                 </div>
